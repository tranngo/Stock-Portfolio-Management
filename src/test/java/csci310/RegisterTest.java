...
public class RegisterTest {
	...
	public void testValidateUserInfo() {
		...
		boolean result = UserInput.validateUserInfo(test_username1, "pwd");
		assertFalse(result);
		...
		result = UserInput.validateUserInfo("usr", test_password1);
		assertFalse(result);
	...
	public void testInsertUser() throws NoSuchAlgorithmException {
		...
		String hashed_password = UserInput.hashPasswordWithSHA256(test_password);
