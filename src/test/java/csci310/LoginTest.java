...
public class LoginTest {
	...
	public void testValidateUserInfo() {		
		...
		String username1 = "";
		String password1 = "";
		boolean result = login.validateUserInfo(username1, password1);
		assertFalse(result);
		
		// Username is valid and password is an empty string - should return false
		String username2 = "user";
		String password2 = "";
		result = login.validateUserInfo(username2, password2);
		assertFalse(result);
		...
		result = login.validateUserInfo(username4, password4);
		assertFalse(result);
		...
		result = login.validateUserInfo(username5, password5);
		assertFalse(result);
		...
		result = login.validateUserInfo(username6, password6);
		assertFalse(result);
